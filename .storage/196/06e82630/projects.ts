...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'End-to-end data management project implementing normalized database schema, generating realistic synthetic datasets, and delivering SQL-driven business intelligence reports with visualizations.',
    domain: 'Academic Projects',
    technologies: ['Python', 'SQL', 'Relational Schema Design', 'Data Visualization', 'Matplotlib', 'Seaborn'],
    status: 'completed' as const,
    impact: 'Established single source of truth for operations with automated synthetic data generation and comprehensive business intelligence reporting',
    keyFeatures: [
    ...
    challenges: [
      'Designing normalized schema that balances performance with data integrity',
      'Generating realistic synthetic data that maintains referential integrity',
      'Creating efficient SQL queries for complex business intelligence requirements'
    ],
    results: [
      'Successfully implemented normalized SQLite database with full constraint enforcement',
      'Generated comprehensive synthetic datasets with 500+ records per entity',
      'Delivered automated business intelligence pipeline with clear visualizations'
    ],
    duration: 'Academic Project',
    teamSize: 1,
