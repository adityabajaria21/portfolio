...
export default function Index() {
  ...
  const handleResumeDownload = () => {
    ...
    window.open('/Aditya_Bajaria_CV.pdf', '_blank');
  };
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-6xl font-bold mb-4">
              ...
              <span className="text-gray-800">Bajaria</span>
            </h1>
      ...
      <section id="about" className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="text-lg text-gray-500 max-w-4xl mx-auto mb-8">
              Analytics Engineering • Data Automation • Reporting Transformation • Data Integrity • Insight Delivery • Decision Acceleration • Market Insights • Customer Analytics • Growth Discovery • Trend Forecasting • Revenue Impact
            </div>
            <div className="text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed text-justify">
              I am a data analyst with 3+ years of experience across FMCG and Entertainment Industries who specializes in answering critical business questions. Instead of just reporting on metrics, I tackle the complex challenges behind them: whether that means pinpointing bottlenecks in a key operational process to improve efficiency, or identifying the most profitable service lines to guide future strategy. My work provides the evidence needed for teams and leadership alike to move from ambiguity to decisive action.
              <br /><br />
              My value extends beyond the technical analysis. I focus on closing the loop between data and decision-makers across the business. This involves presenting complex findings in a clear, concise format and working collaboratively with stakeholders to ensure the insights are not only understood but are also practical to implement. I'm not here to just build dashboards; I'm here to be a strategic partner focused on driving meaningful, company-wide results.
            </div>
          </div>
          <ProfessionalSummary />
        </div>
