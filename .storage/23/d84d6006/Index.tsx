...
import { ChevronDown, Sparkles, Database, Brain, Award, Mail, Phone, Linkedin, Download } from "lucide-react";
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8 text-white">
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold px-4 py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-12">
              ...
              machine learning, and statistical modeling. Specialized in driving revenue growth and 
              operational efficiency across finance, e-commerce, and insurance sectors.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="border-t border-gray-700 pt-8">
            <p className="text-gray-400">
              © 2024 Aditya Bajaria. Built with React, TypeScript, and Tailwind CSS.
            </p>
          </div>
        </div>
      </footer>
