...
import { ChevronDown, Sparkles, Database, TrendingUp, Brain, Award } from "lucide-react";
...
export default function Index() {
  ...
  const stats = [
    ...
    { label: "Industries Analyzed", value: "5+", icon: TrendingUp },
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="mb-8">
            ...
            <p className="text-gray-400">Senior Data Analyst & Machine Learning Engineer</p>
          </div>
