...
export default function Index() {
  ...
  const stats = [
    { label: "Projects Completed", value: "20+", icon: Database },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <div className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-12">
              <p>Strategic data analyst skilled in uncovering insights that drive growth, improve efficiency, and support smarter decision-making. Known for bridging the gap between data and business teams through advanced analytics, machine learning, and statistical modelling.</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              ...
              <Button 
                ...
                size="lg"
                variant="outline"
                className="border-white/30 text-white hover:bg-white/10 font-semibold px-8 py-4 rounded-xl shadow-2xl transition-all duration-300 hover:scale-105"
              >
      ...
      {/* Professional Summary Section - ONLY ONE */}
