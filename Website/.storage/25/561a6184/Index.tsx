        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-12">
              Strategic data analyst skilled in uncovering insights that drive growth, improve efficiency, and support smarter decision-making. Known for bridging the gap between data and business teams to deliver meaningful, actionable outcomes through advanced analytics, machine learning, and statistical modelling. Specialised in driving strategies that support commercial, marketing, and financial decision-making.
            </p>
