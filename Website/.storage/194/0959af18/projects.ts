...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Experimental analysis evaluating the effectiveness of a new loan approval model versus the current system through randomized A/B testing to improve decision quality and reduce costly errors.',
    domain: 'Academic Projects',
    technologies: ['R', 'A/B Test', 'Advanced Statistics', 'Confusion Matrix', 'Welch Two Sample T Tests', 'Confidence Intervals', 'Effect Size - Cohen\'s d', 'Power Analysis', 'Excel', 'Data Visualization'],
    status: 'completed' as const,
    impact: 'Demonstrated significant reduction in loan decision errors and improved officer performance through rigorous experimental analysis',
    keyFeatures: [
      ...
      '⚡ Experiment Evaluation Highlights - Type II error, filtered set with confirmed model use, fell from 0.393 to 0.267, 31.9 percent reduction, p = 0.005, d = −1.67. Whole data showed no significant change, p = 0.245, which motivated the filtered analysis. Type I error fell from 0.502 to 0.277, 44.9 percent reduction, p = 0.001, d = −1.96. Agreement ratio rose from 0.749 to 0.872, p = 0.0053, d = −1.60, large effect. Officer final confidence rose from 595.1 to 730.6, p = 4.69e−09, d = −0.63, medium effect. Decision revisions toward model advice increased, mean 0.055 to 0.120, p = 0.0054, d = −0.77, medium effect.'
    ],
    challenges: [
      'Ensuring experimental validity and controlling for confounding variables',
      'Handling incomplete experiments and officer compliance with model usage',
      'Balancing statistical significance with practical business impact'
    ],
    results: [
      'Demonstrated significant reduction in Type I and Type II loan decision errors',
      'Proved increased officer confidence and alignment with model recommendations',
      'Provided clear statistical evidence for business decision on model deployment'
    ],
    duration: 'Academic Project',
    teamSize: 1,
