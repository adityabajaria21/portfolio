...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'Business Statistics Analysis: CVD & Customer Satisfaction',
    description: 'Dual statistical analysis project examining cardiovascular disease prevalence in England and customer satisfaction patterns in furniture retail using classical regression and hypothesis testing.',
    domain: 'Academic Projects',
    technologies: ['R', 'Exploratory Data Analysis', 'Classical Regression', 'NHST and Estimation', 'Hypothesis Tests', 'ANOVA', 'Multicollinearity Diagnostics', 'Excel', 'Data Visualization'],
    status: 'completed' as const,
    ...
    challenges: [
      'Managing multicollinearity between predictor variables',
      'Ensuring statistical assumptions for regression modeling',
      'Translating complex statistical results into actionable business insights'
    ],
    results: [
      'Identified key drivers of cardiovascular disease prevalence across English local authorities',
      'Quantified relationships between operational factors and customer satisfaction in retail',
      'Delivered statistically sound recommendations for public health and retail management'
    ],
    duration: 'Academic Project',
    teamSize: 1,
