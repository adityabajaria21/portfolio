      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <div className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-12 space-y-2">
              <p>Strategic data analyst skilled in uncovering insights that drive growth, improve efficiency, and support smarter decision-making.</p>
              <p>Known for bridging the gap between data and business teams through advanced analytics,</p>
              <p>machine learning, and statistical modelling.</p>
            </div>
